    ...
    @foreach ($projects as $project)
        <div class="card p-4 shadow mb-3">
            <form action="{{ route('projects.update', $project->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-2">
                    <input type="text" name="short_description" class="form-control" value="{{ $project->short_description }}" required>
                </div>
                <div class="mb-2">
                ...
                <div class="mb-2">
                    @if($project->image)
                        <img src="{{ asset('storage/' . $project->image) }}" height="80" width="80" class="rounded mb-2">
                    @endif
                    <input type="file" name="image" class="form-control">
                </div>
